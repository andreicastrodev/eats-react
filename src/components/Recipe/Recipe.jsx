...
const Recipe = () => {
    ...
    const bookmarkedItem = newBookmarkedItems.some((item) => item.recipeId === newRecipe.recipeId);
    ...
    console.log(newRecipe.bookmarked)
    return (
        <React.Fragment> {
            shouldRecipeSpin ? (
                <Spinner/>) : (
                <div className={
                    ...
                    <div className={
                        styles.recipeCookInfo
                    }>
                        <div className={
                            styles.recipeTime
                        }>
                            <Star className={
                                styles.recipeTimeSvg
                            }/>
                            <span>{
                                newRecipe.socialRank
                            }</span>
                        </div>
                        <div className={
                            ...
                            <button onClick={addBookmarkHandler}
                                className={
                                    styles.recipeBookmarkButton
                            }>
                                {
                                bookmarkedItem ? <BookmarkFill className={
                                    styles.recipeServingSvg
                                }/> : <Bookmark className={
                                    styles.recipeServingSvg
                                }/>
                            } </button>
